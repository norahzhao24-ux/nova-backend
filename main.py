...
acne_descriptions = {
    ...
    "acne2": "Your skin shows noticeable inflammatory pimples or clusters of breakouts. This suggests active irritation that benefits from targeted treatment and routine consistency.",
    "acne3": "Your skin shows deeper, more widespread inflammation. This level often involves cystic or nodular lesions and may require a structured treatment plan for best results."
}
